// Pages/backend/Donor/Layout/Hospital_Layout.jsx
        ...
        <div className="navbar bg-base-100 border-b border-base-300 px-2 h-16 flex justify-between lg:justify-end">
          ...
          <div className="flex-1 pl-3 hidden lg:block">
            <h2 className="text-lg font-semibold tracking-wide">
              Welcome back, <span className="text-error ml-2">Hospital : {user?.profile?.fullName || "User"}</span>
            </h2>
          </div>
...
export default Hospital_Layout;