...
const DonationHistory = () => {
  ...
  return (
    <div className="space-y-6 min-h-screen bg-base-200 p-6">
      ...
      {detailsModalOpen && selectedDonation && (
        <dialog className="modal modal-open" onClick={closeDetailsModal}>
          <div className="modal-box" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-base-200 rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p>{selectedDonation.nextEligibleDate
              ...
              <div className="bg-base-200 rounded-lg p-4">
                ...
                <div className="space-y-2 text-sm">
                  <p>
                    <span className="opacity-70">Donation Date:</span>{' '}
                    {formatDate(selectedDonation.date)}
                  </p>
            ...
            <div className="modal-action">
              <button onClick={closeDetailsModal} className="btn btn-error">
                Close
              </button>
            </div>
          </div>
